...
<html>
<head>
    <title>Signe vitaux create</title><style>
    * {
        margin: 0;
        padding: 0;
...
<div class="container">
    ...
    <form method="post" action="${pageContext.request.contextPath}/SigneVital">
        ...
        <div class="form-group">
            <label for="frequenceCardiaque">frequenceCardiaque</label>
            <input type="text" id="frequenceCardiaque" name="frequenceCardiaque" required>
        </div>
