...
<html>
<head>
    <title>Dossier medical create</title><style>
    * {
        margin: 0;
        padding: 0;
...
<div class="container">
    ...
    <form method="post" action="${pageContext.request.contextPath}/Dossier-Medical">
        ...
        <div class="form-group">
            ...
            <input type="text" id="allergie" name="allergie" required>
        </div>
        ...
        <div class="form-group">
            <label for="Psurgeries">Past surgeries</label>
            <input type="text" id="Psurgeries" name="Psurgeries" required>
        </div>
